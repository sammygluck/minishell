...
/*   Updated: 2024/01/12 14:17:56 by jsteenpu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	expander(t_token **token_head, t_env_var *env_head)
{
	...
	while (head)
	{
		...
		//	meaning: don't expand or remove quotes, leave delimiter string as is
		//	delimiter will be handled in executor within heredoc files
